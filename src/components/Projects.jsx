            ...
            >
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-[#2e2e2c]">
                <a
                  ...
                  className="flex items-center gap-1.5 text-sm text-[#AFACA1] hover:text-[#C9C8BF] transition-colors"
                >
                ...
                {project.live && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-1.5 text-sm text-[#AFACA1] hover:text-[#C9C8BF] transition-colors ml-auto"
                  >
                    Live Demo
